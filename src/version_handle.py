...
# import sys
# import time
# from utils import server_choice
# from conf import DYNAMIC_USER
# from conf import DYNAMIC_PASSWORD
from conf import *

class GameUpdateRenderHandler(BaseHandler):
    @asynchronous
    def self_get(self):
        # self.application.server_db.select_all(self.show)
...
#     def self_get(self):
#         self.render("game_dynamic.html",title="动态更新",channel=get_channel_map())
