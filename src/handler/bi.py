...
'40002':{'X':4,'Y':2,'name':'普通怪物','step':'新手地图1','order':1},
'60002':{'X':6,'Y':2,'name':'高级怪物','step':'新手地图1','order':2},
'80001':{'X':8,'Y':1,'name':'普通怪物','step':'新手地图1','order':3},
'80002':{'X':8,'Y':2,'name':'火盾怪物','step':'新手地图1','order':4},
'80003':{'X':8,'Y':3,'name':'普通怪物','step':'新手地图1','order':5},
'100001':{'X':10,'Y':1,'name':'陶罐','step':'新手地图1','order':6},
'100003':{'X':10,'Y':3,'name':'陶罐','step':'新手地图1','order':7},
'110001':{'X':11,'Y':1,'name':'陶罐','step':'新手地图1','order':8},
'110003':{'X':11,'Y':3,'name':'陶罐','step':'新手地图1','order':9},
'130002':{'X':13,'Y':2,'name':'火盾怪物','step':'新手地图1','order':10},
'150002':{'X':15,'Y':2,'name':'新手2层入口','step':'新手地图1','order':11},
'20002':{'X':2,'Y':2,'name':'陷阱','step':'新手地图2','order':12},
'50002':{'X':5,'Y':2,'name':'火盾怪物','step':'新手地图2','order':13},
'50003':{'X':5,'Y':3,'name':'普通怪物','step':'新手地图2','order':14},
'60001':{'X':6,'Y':1,'name':'普通怪物','step':'新手地图2','order':15},
'70003':{'X':7,'Y':3,'name':'陶罐','step':'新手地图2','order':16},
'80001':{'X':8,'Y':1,'name':'陶罐','step':'新手地图2','order':17},
'80003':{'X':8,'Y':3,'name':'普通怪物','step':'新手地图2','order':18},
'90001':{'X':9,'Y':1,'name':'普通怪物','step':'新手地图2','order':19},
'90002':{'X':9,'Y':2,'name':'火盾怪物','step':'新手地图2','order':20},
'110001':{'X':11,'Y':1,'name':'陶罐','step':'新手地图2','order':21},
'110002':{'X':11,'Y':2,'name':'陷阱','step':'新手地图2','order':22},
'110003':{'X':11,'Y':3,'name':'普通怪物','step':'新手地图2','order':23},
'130001':{'X':13,'Y':1,'name':'普通怪物','step':'新手地图2','order':24},
'130003':{'X':13,'Y':3,'name':'普通怪物','step':'新手地图2','order':25},
'140002':{'X':14,'Y':2,'name':'BOSS','step':'新手地图2','order':26},
'150002':{'X':15,'Y':2,'name':'回城出口','step':'新手地图2','order':27},
}
