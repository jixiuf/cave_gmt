...
class MailDB:
    ...
    def add(self,mailId,uin,startTime,endTime,awardStr,conent):
        query="insert into MailSystem (mailId,uin,FromUin,MailType,StartTime,EndTime,AwardStr,Content,Reason) values(%d,%s,0,0,'%s','%s','%s','%s','system')"%(mailId,str(uin),startTime,endTime,awardStr,conent)
